...
#include "icl/function_impls.h"  // Where |TemplateFn()| is declared.
...
class TemplateImpl : public Function {
 public:
  TemplateImpl() = default;
  ~TemplateImpl() override = default;
  ...
  Value GenericBlockFn(Scope* scope,
    ...
    scope->AddTemplate(template_name,
                       MakeRefCounted<Template>(scope, function));
