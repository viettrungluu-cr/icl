...
#ifndef ICL_REF_COUNTED_H_
#define ICL_REF_COUNTED_H_

#include "icl/ref_counted_internal.h"
...
#define FRIEND_REF_COUNTED_THREAD_SAFE(T) \
  friend class ::icl::RefCountedThreadSafe<T>
...
#define FRIEND_MAKE_REF_COUNTED(T) \
  friend class ::icl::internal::MakeRefCountedHelper<T>

}  // namespace icl

#endif  // ICL_REF_COUNTED_H_
